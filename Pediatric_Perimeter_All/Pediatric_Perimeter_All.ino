...
//  pixels.Color takes RGB values, from 0,0,0 up to 255,255,255
    ...
    pixels1.setPixelColor(i, pixels25.Color(r,g,b)); // Moderately bright green color.
...
// pixels.Color takes RGB values, from 0,0,0 up to 255,255,255
    ...
    pixels25.setPixelColor(j, pixels25.Color(r,g,b));// Moderately bright green color.
...
//  pixels.Color takes RGB values, from 0,0,0 up to 255,255,255
    pixels1.setBrightness(Br);
    pixels1.setPixelColor(i, pixels1.Color(r,g,b)); // Moderately bright green color.
    pixels1.show(); // This sends the updated pixel color to the hardware.
//  delay(0); // Delay for a period of time (in milliseconds).
...
// pixels.Color takes RGB values, from 0,0,0 up to 255,255,255
    ...
    pixels3.setPixelColor(i, pixels3.Color(r,g,b)); // Moderately bright green color.
...
//  pixels.Color takes RGB values, from 0,0,0 up to 255,255,255
    ...
    pixels4.setPixelColor(i, pixels4.Color(r,g,b)); // Moderately bright green color.
...
//  pixels.Color takes RGB values, from 0,0,0 up to 255,255,255
    ...
    pixels5.setPixelColor(i, pixels5.Color(r,g,b)); // Moderately bright green color.
...
//  pixels.Color takes RGB values, from 0,0,0 up to 255,255,255
    ...
    pixels6.setPixelColor(i, pixels6.Color(r,g,b)); // Moderately bright green color.
...
//  pixels.Color takes RGB values, from 0,0,0 up to 255,255,255
    ...
    pixels7.setPixelColor(i, pixels7.Color(r,g,b)); // Moderately bright green color.
...
//  pixels.Color takes RGB values, from 0,0,0 up to 255,255,255
    ...
    pixels8.setPixelColor(i, pixels8.Color(r,g,b)); // Moderately bright green color.
...
//  pixels.Color takes RGB values, from 0,0,0 up to 255,255,255
    ...
    pixels9.setPixelColor(i, pixels9.Color(r,g,b)); // Moderately bright green color.
...
//  pixels.Color takes RGB values, from 0,0,0 up to 255,255,255
    ...
    pixels10.setPixelColor(i, pixels10.Color(r,g,b)); // Moderately bright green color.
...
//  pixels.Color takes RGB values, from 0,0,0 up to 255,255,255
    ...
    pixels11.setPixelColor(i, pixels11.Color(r,g,b)); // Moderately bright green color.
...
//  pixels.Color takes RGB values, from 0,0,0 up to 255,255,255
    ...
    pixels12.setPixelColor(i, pixels12.Color(r,g,b)); // Moderately bright green color.
...
// pixels.Color takes RGB values, from 0,0,0 up to 255,255,255
    ...
    pixels13.setPixelColor(i, pixels13.Color(r,g,b)); // Moderately bright green color.
...
//  pixels.Color takes RGB values, from 0,0,0 up to 255,255,255
    ...
    pixels14.setPixelColor(i, pixels14.Color(r,g,b)); // Moderately bright green color.
...
//  pixels.Color takes RGB values, from 0,0,0 up to 255,255,255
    ...
    pixels15.setPixelColor(i, pixels15.Color(r,g,b)); // Moderately bright green color.
...
//  pixels.Color takes RGB values, from 0,0,0 up to 255,255,255
    ...
    pixels16.setPixelColor(i, pixels16.Color(r,g,b)); // Moderately bright green color.
...
//  pixels.Color takes RGB values, from 0,0,0 up to 255,255,255
    ...
    pixels17.setPixelColor(i, pixels17.Color(r,g,b)); // Moderately bright green color.
...
//  pixels.Color takes RGB values, from 0,0,0 up to 255,255,255
    ...
    pixels18.setPixelColor(i, pixels18.Color(r,g,b)); // Moderately bright green color.
...
//  pixels.Color takes RGB values, from 0,0,0 up to 255,255,255
    ...
    pixels19.setPixelColor(i, pixels19.Color(r,g,b)); // Moderately bright green color.
...
//  pixels.Color takes RGB values, from 0,0,0 up to 255,255,255
    ...
    pixels20.setPixelColor(i, pixels20.Color(r,g,b)); // Moderately bright green color.
...
//  pixels.Color takes RGB values, from 0,0,0 up to 255,255,255
    ...
    pixels21.setPixelColor(i, pixels21.Color(r,g,b)); // Moderately bright green color.
...
//  pixels.Color takes RGB values, from 0,0,0 up to 255,255,255
    ...
    pixels22.setPixelColor(i, pixels22.Color(r,g,b)); // Moderately bright green color.
...
//  pixels.Color takes RGB values, from 0,0,0 up to 255,255,255
    ...
    pixels23.setPixelColor(i, pixels23.Color(r,g,b)); // Moderately bright green color.
